...
ser = serial.Serial(port='COM16', baudrate =9600, bytesize=8, timeout=2,stopbits=serial.STOPBITS_ONE)
...
while True:
    ...
    for face in faces:
        ...
        cv2.putText(image, "Number of blinks " + str(EYE_CLOSED_COUNTER),(10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 255), 2)

        if ear < MINIMUM_EAR: 
            i=i+1
            if i>=50:
                ser.write("1".encode())
                cv2.putText(image, " Driver is asleep ", (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 255), 2)
